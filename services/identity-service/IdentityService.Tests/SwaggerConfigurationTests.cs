...
public class SwaggerConfigurationTests : IClassFixture<IdentityServiceApplicationFactory>
{
    private readonly IdentityServiceApplicationFactory _factory;

    public SwaggerConfigurationTests(IdentityServiceApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    public async Task SwaggerUiEndpoint_IsReachableInDevelopment()
    {
        ...
        html.Should().Contain("Identity Service API v1");
    }
}
