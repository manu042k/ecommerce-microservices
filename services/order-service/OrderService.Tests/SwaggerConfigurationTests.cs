...
public class SwaggerConfigurationTests : IClassFixture<OrderServiceApplicationFactory>
{
    private readonly OrderServiceApplicationFactory _factory;

    public SwaggerConfigurationTests(OrderServiceApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    public async Task SwaggerUiEndpoint_IsReachableInDevelopment()
    {
        ...
        html.Should().Contain("Order Service API v1");
    }
}
