...
public class SwaggerConfigurationTests : IClassFixture<CatalogServiceApplicationFactory>
{
    private readonly CatalogServiceApplicationFactory _factory;

    public SwaggerConfigurationTests(CatalogServiceApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    public async Task SwaggerUiEndpoint_IsReachableInDevelopment()
    {
        ...
        html.Should().Contain("Catalog Service API v1");
    }
}
