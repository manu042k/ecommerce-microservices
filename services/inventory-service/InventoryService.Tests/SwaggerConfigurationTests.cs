...
public class SwaggerConfigurationTests : IClassFixture<InventoryServiceApplicationFactory>
{
    private readonly InventoryServiceApplicationFactory _factory;

    public SwaggerConfigurationTests(InventoryServiceApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    public async Task SwaggerUiEndpoint_IsReachableInDevelopment()
    {
        ...
        html.Should().Contain("Inventory Service API v1");
    }
}
